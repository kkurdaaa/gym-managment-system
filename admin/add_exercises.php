...
<?php 
	...
	if (isset($_POST['insert_workout']))
	{
		...
		//  Image Name
		$exercise_img= $_FILES['exer_img']['name'];		//$_FILES is an associative array containing items uploaded via HTTP POST method.
		...
		elseif ($exercise_img=='') {
			...
			move_uploaded_file($temp_name, "exercise_images/$exercise_img"); //move an uploaded file to new location
